    ...
    <form class="form-group" id="adminForm" method="post" action="admin.php">
        ...
        <fieldset class="form-group" id="form_fieldset">
            ...
            <!--<div class="col-sm-6 pl-3" id="divSubmitQuestion">
                ...
                <input class="btn btn-primary float-left mt-3" type="submit" id="submit" value="Submit New Question/Answer"/>
                </a>
                <button type="button" class="btn btn-danger float-right mt-3" id="cancel_button" onclick=cancelQuestion()>
                    Clear
                </button>
            </div>-->
